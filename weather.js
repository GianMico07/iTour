...
const KELVIN = 273;
// API KEY
const key = "3994577e0dee4fd8dd30a40668685ca5";
...
function displayWeather(){
    iconElement.innerHTML = `<img class="weather-img" src="/icons/${weather.iconId}.png"/>`;
...
tempElement.addEventListener("click", function(){
    ...
    if(weather.temperature.unit == "celsius"){
        ...
        tempElement.innerHTML = `${fahrenheit}°<span class="degree">F</span>`;
